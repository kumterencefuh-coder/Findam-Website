...
function Home({ city, setCity, type, setType, maxPrice, setMaxPrice, search, onOpen, savedIds, onSave, go }) { return <>
  ...
  </div><div className="hero-visual"><div className="hero-panel" style={{ overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><img src={beautifulHouse} alt="Beautiful house" className="hero-watermark" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'right center' }} /><div className="hero-city-stack"><span className="city-pill">Bamenda</span><span className="city-pill offset">Buea</span><span className="city-pill">Yaounde</span></div></div><div className="verified-float">✓ <span>Agent visited<br />Engineer reviewed</span></div><div className="stat-float"><b>120+</b><span>Verified homes</span></div></div></div></section>
